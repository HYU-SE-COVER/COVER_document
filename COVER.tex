...
\begin{enumerate}[label=\arabic*.]
\item ESP32-S3\\
\begin{figure}[H]\centering \includegraphics[scale=0.3]{images/esp32-s3.png}\end{figure}
\begin{itemize}
...
\begin{figure}[H]\centering \includegraphics[scale=0.3]{images/esp32-s3-wroom-1.png}\end{figure}
\begin{itemize}
...
\end{itemize}
\end{enumerate}
\begin{figure}[H]\centering \includegraphics[scale=0.3]{images/series-comparison.png}\end{figure}
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{images/cost.png}
\end{figure}
