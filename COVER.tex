...
\end{enumerate}
\end{enumerate} % subsection backend [arabic]
...
\end{enumerate} % subsection embedded [arabic]
...
\bibitem{b18} Node.js. (n.d.). [Home page]. nodejs.org. Retrieved December 2, 2023, from https://nodejs.org/en/about\\
